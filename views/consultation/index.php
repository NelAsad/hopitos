                    ...
                    <form class="ui mini form" id="form_commencer_consultation">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <textarea class="77advanced_textarea form-control" rows="7" id="commencer_consultation_symptomes"></textarea>
                            </div>
                            <div class="col-xs-12">
                                <label>Diagnostic</label>
                                <textarea class="77advanced_textarea form-control" rows="7" id="commencer_consultation_diagnostic" placeholder="Diagnostic"></textarea>
                            </div>
                        </div>
                    </form>
                </div>
